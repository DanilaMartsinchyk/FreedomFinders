...
public class DrawingSurface extends PApplet {
	...
	/**
	 * returns a standing player
	 * 
	 * @return a standing player with type Player
	 */
	...
	/**
	 * returns a jumping player
	 * 
	 * @return a jumping player with type Player
	 */
	...
	/**
	 * returns a running player
	 * 
	 * @return a running player with type Player
	 */
	 ...
	 * returns a trash can
	 * 
	 * @param x x coordinate of the top left of the trash can
	 * @param y y coordinate of the top left of the trash can
	 * @return a trash can with type Obstacle
	 */
	 ...
	 * returns a spike
	 * 
	 * @param x x coordinate of the top left of the spike
	 * @param y y coordinate of the top left of the spike
	 * @return a spike with type Obstacle
	 */
